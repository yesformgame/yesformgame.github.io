...
var initEnemies = function() {
	...
	asterisks.forEach( function( ast ) {
	    ...
	    ast.tweens.pump.tween.to( { x: 1.6, y: 1.6 }, 500, Phaser.Easing.Bounce.Out, true, game.rnd.integerInRange( 0, 200 ), true, true );
	    ast.tweens.pump.tween.repeatDelay( game.rnd.integerInRange( 3000, 5000 ) );
