    ...
    var completeArea = function( area ) {
        ...
        return function() {
            ...
            thisArea.images.greenOutline.sprite = game.add.sprite( 
                thisArea.images.greenOutline.position.x - 28, // adjust for fade width 
                thisArea.images.greenOutline.position.y - 28, // adjust for fade height
    ...
    var incompleteArea = function( area ) {
        ...
        return function() {
            ...
            thisArea.images.redOutline.sprite = game.add.sprite( 
                thisArea.images.redOutline.position.x - 28, // adjust for fade width 
                thisArea.images.redOutline.position.y - 28, // adjust for fade height
