...
var buildAreas = function() {
    ...
    var completeArea = function( area ) {
        ...
        return function() {
            ...
            thisArea.images.greenOutline.sprite = game.add.sprite( 
                thisArea.images.greenOutline.position.x - 5, // adjust for fade width 
                thisArea.images.greenOutline.position.y - 5, // adjust for fade height
            ...
            thisArea.images.stamp.tween.from( { x: .1, y: .1 }, 500, Phaser.Easing.Elastic.Out, true );

            thisArea.images.greenOutline.tween = game.add.tween( thisArea.images.greenOutline.sprite );
            thisArea.images.greenOutline.tween.to( { alpha: 0 }, 500, Phaser.Easing.Linear.None, true );
    ...
    var resetArea = function( area ) {
        ...
        return function() {
            ...
            if( thisArea.images.greenOutline.sprite ) {
