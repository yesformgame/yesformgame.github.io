...
function preload() {
    ...
    game.load.tilemap(      'new-level',    'assets/imgs/in-form-tall-cursor-zoom-out.json', null, Phaser.Tilemap.TILED_JSON );
...
function create() {
    ...
    label1 = game.add.sprite( 80, 0, 'label' );
    label2 = game.add.sprite( 80, 180, 'label-2' );
    ...
    player.scale.y = 1;
    // add scale to gui
    gui.add( player.scale, 'y', .25, 1.5 ).step( .25 ).onFinishChange( restart );
