...
function preload() {
    ...
    game.load.tilemap(      'new-level',    'assets/imgs/in-form-tall-cursor-holes.json', null, Phaser.Tilemap.TILED_JSON );
...
function create() {
    ...
    label1 = game.add.sprite( 80, 112, 'label' );
    label2 = game.add.sprite( 80, 330, 'label-2' );
